...
import {
  ...
  useStore,
  Bits,
} from "react-petit-hooks/lib/storage"
    ...
    <div className="page-active-bg">
      ...
      >
        <div className="form" id="export">
          ...
          <div className="welcome-btns col4">
            <Btn state={useWelcome} as="finish">
              {" "}
              終了した村
            </Btn>
            <Btn state={useWelcome} as="progress">
              進行中の村
            </Btn>
          </div>
        ...
        <div className="btns form">
          <span>
            <Btn state={useBg} as="BG">
              １
            </Btn>
            <Btn state={useBg} as="BG75">
              ¾
            </Btn>
            <Btn state={useBg} as="BG50">
              ½
            </Btn>
          </span>
          <span>
            <Btn state={useFont} as="large">
              大判
            </Btn>
            <Btn state={useFont} as="novel">
              明朝
            </Btn>
            <Btn state={useFont} as="press">
              新聞
            </Btn>
          </span>
          <span>
            <Btn state={useFont} as="goth-L">
              L
            </Btn>
            <Btn state={useFont} as="goth-M">
              M
            </Btn>
            <Btn state={useFont} as="goth-S">
              S
            </Btn>
          </span>
          <span>
            <Btn state={useTheme} as="cinema">
              煉瓦
            </Btn>
            <Btn state={useTheme} as="pop">
              {" "}
              噴出
            </Btn>
            <Btn state={useTheme} as="snow">
              {" "}
              雪景
            </Btn>
            <Btn state={useTheme} as="star">
              {" "}
              蒼穹
            </Btn>
            <Btn state={useTheme} as="night">
              {" "}
              闇夜
            </Btn>
            <Btn state={useTheme} as="moon">
              {" "}
              月夜
            </Btn>
            <Btn state={useTheme} as="wa">
              {" "}
              和の国
            </Btn>
          </span>
          <span>
            <Btn state={usePin} as={false}>
              0
            </Btn>
            show.pin
            <Btn state={usePin} as={true}>
              1
            </Btn>
          </span>
          <span>
            <Btn state={useMention} as={false}>
              0
            </Btn>
            show.mention
            <Btn state={useMention} as={true}>
              1
            </Btn>
          </span>
        </div>
      ...
      <div className="page-active">
        <div className="outframe">
          ...
          <div
            className="summaryframe options"
            name="list"
            tag="div"
            key="summary"
          >
